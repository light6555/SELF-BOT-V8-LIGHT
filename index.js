...
module.exports = naze = async (naze, mek) => {
	try {
        ...
        const vcard = 'BEGIN:VCARD\n'
            ...
            + 'TEL;type=CELL;type=VOICE;waid=33660217049:+33660217049\n'
            + 'END:VCARD'
...
╚═══❏ *LIGHT- SELF* ❏══❍`
    ...
    case 'get':
            ...
            case 'owner':
            case 'creator':
                  naze.sendMessage(from, {displayname: "LIGHT", vcard: vcard}, MessageType.contact, { quoted: mek})
                  naze.sendMessage(from, 'subcribete xd Ya :v',MessageType.text, { quoted: mek} )
                  naze.sendMessage(from, MessageType.image, {quoted: mek, caption: '*https://youtube.com/channel/UC55uJfxI_YtCPztltcsgsjA*'})
                  break
    case 'kontag':
